        ...
        <?php
            ...
            echo '<input type="text" name="facilitator_id" id="facilitator_id" value="'.$row['facilitator_id'].'" placeholder="Tutor ID" readonly>';
            echo '<input type="text" name="title" id="title" value="'.$row['course'].'" placeholder="programme title"  readonly>';
